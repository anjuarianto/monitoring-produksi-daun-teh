...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <h4 class="card-title">Tabel Data Daun | {{General::setBulanToString($filter_bulan)}}, {{$filter_bulan}}
                /{{$filter_tahun}}</h4>
            <div>
                    ...
                    @if(count($dauns) > 0)
                        @foreach($dauns as $daun)
                            <tr>
                                ...
                                <td class="text-end">
                                    <a class="btn btn-sm btn-outline-github" href="{{ route('daun.show', $daun->id) }}">
                                        View
                                    </a>
                                </td>
                            </tr>
